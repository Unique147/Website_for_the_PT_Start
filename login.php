        ...
        <div class="row">
            <div class="col-12">
                <form method='POST' action='/login.php'>
                    <div class="row form__reg"><input class="form" type="username" name="username" placeholder="Login"></div>
                    <div class="row form__reg"><input class="form" type="password" name="password" placeholder="Password"></div>
                    <button class="btn_red btn_reg" type="submit" name="submit">Продолжить</button>
                </form>
            </div>
        </div>
    </div>
